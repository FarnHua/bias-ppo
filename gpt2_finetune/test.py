...
df_test.to_csv(f"./RL_Result/{args.bot}/{args.bot}-distinct1000-test.csv")

df_incontext = pd.DataFrame(incontext_data, columns=['sentence'])
df_incontext.to_csv(f"./RL_Result/{args.bot}/{args.bot}-distinct1000-incontext.csv")
