...
INTRO_BLURB = (
    # DENONSTRATION
    "You are a chatbot intended to respond to the following input in one sentence without repeating it."
...
class InstructionTextGenerationPipeline(Pipeline):
    def __init__(
        self, *args, do_sample: bool = False, max_new_tokens: int = 256, top_p: float = 0.92, top_k: int = 0, **kwargs
    ):
