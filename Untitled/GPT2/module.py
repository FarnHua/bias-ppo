...
class prompt(base):
    def __init__(self, config):
        ...
        # if exists("results/" + config.model_ckpt + f"/checkpoint-step-{self.args.init_step}-value.pkl"):
        #     self.optimizer.load_state_dict(torch.load("results/" + config.model_ckpt + f"/checkpoint-step-{self.args.init_step}-optimizer.pkl"))
